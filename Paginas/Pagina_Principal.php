...
<head>
    ...
    <title>Panel del Asegurado</title>
...
<body class="dashboard-body">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <hr>
            <li class="menu-item">
                <a href="Pagina_PrincipalA.php"><i class="fa-solid fa-user-gear"></i> Pagina de Principal de Ajustadores</a>
            </li>
            <li class="menu-item">
                ...
                <div class="siniestro-card" onclick="abrirDetalleSiniestro('Inundación por lluvias', 'Multimedia/Video/Inundado.mp4', 'Pérdida Total', 'Juan Pérez', '15 de Feb, 2026 • 16:15', 'Daños severos por ingreso de agua al motor y cabina durante tormenta.')">
                    ...
                    <div class="card-info">
                        ...
                        <div class="card-text">
                            ...
                            <p class="card-author">Ajustador: Juan Pérez</p>
